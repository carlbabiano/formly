...
if ($survey) {
    ...
    foreach ($questions as &$question) {
        ...
        if ($question['question_type'] === 'linear-scaling') { // Correct field name
        ...
        if ($question['question_type'] === 'rating') {
            $question['ratingScale'] = isset($question['rating_scale']) ? $question['rating_scale'] : null; // Default to 5
            $question['ratingShape'] = isset($question['rating_shape']) ? $question['rating_shape'] : null; // Default to 'star'
        }
